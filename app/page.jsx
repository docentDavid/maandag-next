    ...
    <main className="grid">
      ...
      <div className="welcome">
        ...
        <p>
          ...
          optimization, and built-in routing, making development more efficient.
          With its performance optimizations and seamless integration with
          backend services, Next.js is widely used for scalable and SEO-friendly
          web projects.
        </p>
      </div>
      <h2>Key Features</h2>
      ...
      <div className="card">
        ...
        <p>
          Next.js allows you to create backend API endpoints within the project
          using serverless functions. These endpoints can handle database
          queries, authentication, and other backend tasks.
        </p>
        <p>
      ...
      <div className="card">
        ...
        <p>
          This reduces initial load times and improves user experience. It also
          optimizes assets like images and scripts, ensuring faster performance.
          Features like lazy loading and caching enhance efficiency further.
        </p>
      </div>
    </main>
  );
